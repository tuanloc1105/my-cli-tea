...
`AGENTS.md` is the writable source of truth for agent-facing instructions in this repository.
...
- `docs/agent/cli-conventions.md` - shared Cobra lifecycle, stream, error, compatibility, and command-test contract.
